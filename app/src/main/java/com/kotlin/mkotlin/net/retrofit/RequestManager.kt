...
object RequestManager {
     ...
     * 通用网络请求方法
     */
    fun <E> execute(presenter: IPresenter<*>, observable: Observable<BaseResponse<E>>, observer: BaseObserver<E>): Disposable {
        observable
                .map(ResponseConvert())
     ...
     * 通用耗时任务方法
     */
    fun <E> execute(presenter: IPresenter<*>, listener: ExecuteListener<E>, observer: BaseObserver<E>): Disposable {
