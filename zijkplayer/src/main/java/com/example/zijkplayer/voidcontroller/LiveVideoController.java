...
import com.example.zijkplayer.controller.GestureController;
import com.example.zijkplayer.util.PlayerUtils;
import com.example.zijkplayer.views.MarqueeTextView;
 ...
 * 作用:  直播点播控制器
 */
public class LiveVideoController extends GestureController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private Animation mShowAnim = AnimationUtils.loadAnimation(getContext(), R.anim.zijkplayer_alpha_in);
    private Animation mHideAnim = AnimationUtils.loadAnimation(getContext(), R.anim.zijkplayer_alpha_out);
    private BatteryMsReceiver mBatteryReceiver;
    ...
    protected int getLayoutId() {
        return R.layout.zijkplayer_layout_standard_controller;
    }
    ...
    protected void initView() {
        ...
        mBatteryReceiver = new BatteryMsReceiver(mBatteryLevel);
    ...
    public void setPlayState(int playState) {
        ...
        switch (playState) {
            ...
            case IjkVideoView.STATE_PAUSED:
                Log.e("提示","STATE_PAUSED");
                mPlayButton.setSelected(false);
                mStartPlayButton.setVisibility(View.GONE);
                break;
            case IjkVideoView.STATE_PREPARING:
                Log.e("提示","STATE_PREPARING");
                mCompleteContainer.setVisibility(View.GONE);
                mStartPlayButton.setVisibility(View.GONE);
...
//                mLoadingProgress.setVisibility(GONE);
            ...
            case IjkVideoView.STATE_BUFFERED:
                ...
                mStartPlayButton.setVisibility(View.GONE);
                mThumb.setVisibility(View.GONE);
                Log.e("提示","STATE_BUFFERED");
                break;
            case IjkVideoView.STATE_PLAYBACK_COMPLETED:
                Log.e("提示","STATE_PLAYBACK_COMPLETED");
                hide();
    ...
    protected void doLockUnlock() {
        if (mIsLocked) {
            ...
            Toast.makeText(getContext(), "已锁定", Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onBackPressed() {
        if (mIsLocked) {
            show();
            Toast.makeText(getContext(), "请先解锁屏幕", Toast.LENGTH_SHORT).show();
            return true;
        }
