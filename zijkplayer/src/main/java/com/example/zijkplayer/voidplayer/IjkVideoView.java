...
import com.example.zijkplayer.views.ResizeSurfaceView;
import com.example.zijkplayer.views.ResizeTextureView;
...
public class IjkVideoView extends BaseZIjkVideoView {
     ...
     * 设置控制器
     */
    public void setVideoController(@Nullable BaseController mediaController) {
