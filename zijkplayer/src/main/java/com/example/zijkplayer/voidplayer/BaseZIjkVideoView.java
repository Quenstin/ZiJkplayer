package com.example.zijkplayer.voidplayer;
...
import com.example.zijkplayer.controller.BaseController;
import com.example.zijkplayer.controller.MediaPlayerControl;
import com.example.zijkplayer.listener.OnVideoViewStateChangeListener;
import com.example.zijkplayer.listener.PlayerEventListener;
import com.example.zijkplayer.util.PlayerUtils;
import com.example.zijkplayer.util.ProgressUtil;
 ...
 * 创建作者:zhuguoqing
 * 创建日期:2019/2/23
 * 作用: 播放器的封装类，实现播放器就实现这个类
 */
public abstract class BaseZIjkVideoView extends FrameLayout implements MediaPlayerControl,PlayerEventListener {
    public BaseZIjkVideoView(@NonNull Context context) {
        super(context);
    }

    public BaseZIjkVideoView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public BaseZIjkVideoView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    protected AbstractPlayer mMediaPlayer;//播放器
    @Nullable
    protected BaseController mVideoController;//控制器
